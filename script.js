...
gsap.to("#page1-buttom",{
    scrollTrigger:{
        trigger:"#page1-buttom",
        scroller:"#main",
        start:"5% top",
        end:"bottom top",
...
function canvas1(){
    const canvas = document.querySelector("#page33>canvas");
  const context = canvas.getContext("2d");
